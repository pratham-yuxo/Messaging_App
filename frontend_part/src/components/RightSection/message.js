...
const Message = (props) => {
  ...
  background:${
    isSender
      ? darkMode
        ? "linear-gradient( 180deg, #9611b9 0%, rgb(10 61 155) 51%, #1a7eed 92% ) no-repeat center"
        : "#4955e9;"
      : darkMode
      ? "#243156"
      : "white"
  ...
  const TextMsg = () => {
    return (
      <>
        {
          <span
            className={`${isSender ? "msg" : `${darkMode ? "recd" : "rec"}`}`}
            style={myStyle}
          >
            {props.message.text}
          </span>
        ...
        <Box>
          {
            ...
            isPdf ? (
              <Box
                className={`${
                  isSender ? "msg" : `${darkMode ? "recd" : "rec"}`
                }`}
      ...
      >
        ...
        <BoxMenu>
          ...
          >
            ...
            <MenuStyle onClick={(e) => downloadFile(e, props.message.text)}>
              Download
            </MenuStyle>
        ...
        {props.message.type === "file" ? (
          <ImgMsg />
        ) : props.message.type === "deleted" || delEve ? (
          <DeleteMsg />
        ) : (
          <TextMsg />
        )}
